...
task :setup do
  ...
  connection.exec('CREATE TABLE spaces (id SERIAL PRIMARY KEY, Name VARCHAR(60), Address VARCHAR(60), Description VARCHAR(100), No_bedrooms SMALLINT, Price_per_Night money, user_id INT REFERENCES users(user_id));')
